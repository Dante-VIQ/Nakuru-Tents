...
<head>
    ...
    <style>
        ...
        @keyframes markerPulse {
            ...
            50% {
                transform: scale(1.1);
                box-shadow: 0 0 30px rgba(42, 107, 78, 0.5);
            }
        }
...
<body class="bg-gray-50 font-sans">
        ...
        <div class="container mx-auto px-4 relative">
            <div class="max-w-4xl mx-auto text-center fade-in">
                ...
                <p class="text-xl mb-8 text-gray-100 max-w-3xl mx-auto">
                    Ready to start your next adventure? Contact us for event planning, gear rentals, or custom canvas
                    solutions.
                </p>
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="#location"
                        class="bg-white text-gray-800 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="contact-card bg-white rounded-2xl p-8 text-center slide-in-left">
                    ...
                    <div class="space-y-2">
                        <a href="tel:+254701596171"
                            class="text-2xl font-bold text-[#2a6b4e] hover:text-[#3a8b6f] transition block">
                            +254 701 596171
                        </a>
                ...
                <div class="contact-card bg-white rounded-2xl p-8 text-center fade-in">
                    ...
                    <div class="space-y-2">
                        <a href="mailto:info@nakurutents.com"
                            class="text-lg font-bold text-[#2a6b4e] hover:text-[#3a8b6f] transition block">
                            info@nakurutents.com
                        </a>
                        <a href="mailto:sales@nakuruents.com"
                            class="text-lg font-bold text-[#2a6b4e] hover:text-[#3a8b6f] transition block">
    ...
    <section id="location" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                <span
                    class="inline-block px-4 py-2 bg-[#e6b325] text-gray-800 rounded-full text-sm font-semibold mb-4">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 h-full">
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex items-start">
                                <div
                                    class="flex-shrink-0 w-10 h-10 bg-[#2a6b4e] rounded-lg flex items-center justify-center mr-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Free parking available on-site for up to 50 vehicles.
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Fully wheelchair accessible facility with ramps and
                                        automatic doors.</p>
                                </div>
                            </div>
                        </div>
    ...
    <section id="contact-form" class="py-16 pattern-bg">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Fill out the form below and we'll get back to you within 24
                    hours</p>
            </div>
                        ...
                        <form id="contactForm" class="space-y-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="firstName" class="form-input" placeholder="John"
                                        required>
                                    <div id="firstNameError" class="text-red-500 text-sm mt-1 hidden">Please enter
                                        your first name</div>
                                </div>
                                <div>
                                    <label class="form-label">Last Name *</label>
                                    <input type="text" id="lastName" class="form-input" placeholder="Smith"
                                        required>
                                    <div id="lastNameError" class="text-red-500 text-sm mt-1 hidden">Please enter your
                                        last name</div>
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div id="emailError" class="text-red-500 text-sm mt-1 hidden">Please enter a valid
                                        email address</div>
                                </div>
                                <div>
                                    ...
                                    <div id="phoneError" class="text-red-500 text-sm mt-1 hidden">Please enter a valid
                                        phone number</div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="inquiryType" value="event" class="mr-2"
                                            checked>
                                        <span>Event</span>
                                    </label>
                                    <label class="inline-flex items-center">
                            ...
                            <div>
                                ...
                                <textarea id="message" rows="5" class="form-input" placeholder="Tell us about your project or inquiry..."
                                    required></textarea>
                                <div id="messageError" class="text-red-500 text-sm mt-1 hidden">Please enter your
                                    message</div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">We typically respond within 24 hours during
                                        business days.</p>
                                </div>
                                <div>
                                    <h4 class="font-bold text-gray-700 mb-1">Do you offer emergency services?</h4>
                                    <p class="text-gray-600 text-sm">Yes, we offer 24/7 emergency support for existing
                                        clients.</p>
                                </div>
                                <div>
                                    <h4 class="font-bold text-gray-700 mb-1">Can I visit without an appointment?</h4>
                                    <p class="text-gray-600 text-sm">Yes, our showroom is open to walk-ins during
                                        business hours.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div class="flex space-x-4">
                                <a href="#"
                                    class="w-12 h-12 bg-[#2a6b4e] rounded-full flex items-center justify-center hover:bg-[#3a8b6f] transition">
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center fade-in">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    ...
                    <a href="#contact-form"
                        class="btn-outline border-white text-white hover:bg-white hover:text-[#2a6b4e]">
                        <i class="fas fa-envelope mr-2"></i> Send Message
                    </a>
                </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mb-6">Your trusted partner for outdoor adventures and events since 2010.
                    </p>
                    <div class="flex space-x-4">
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            document.addEventListener('click', function(event) {
                ...
                if (!menu.contains(event.target) && !button.contains(event.target) && !menu.classList.contains(
                        'hidden')) {
        ...
        function showNotification(message) {
            ...
            notification.className =
                'fixed bottom-4 right-4 bg-[#2a6b4e] text-white px-6 py-3 rounded-lg shadow-lg transform translate-y-full transition-transform duration-300 z-50';
