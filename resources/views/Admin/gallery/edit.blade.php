                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="is_active" class="flex items-center cursor-pointer">
                                            <div class="relative">
                                                <div class="w-11 h-6 bg-gray-200 rounded-full shadow-inner transition-colors duration-200 {{ old('is_active', $gallery->is_active) ? 'bg-green-400' : '' }}"></div>
                                                <div class="absolute w-4 h-4 bg-white rounded-full shadow transition-transform duration-200 {{ old('is_active', $gallery->is_active) ? 'translate-x-6' : 'translate-x-1' }}"></div>
                                            </div>
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('gallery.destroy', $gallery) }}"
                            ...
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg inline-flex items-center justify-center transition duration-150 ease-in-out">
